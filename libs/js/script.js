function createCard(result) {
  var card =
    "<div class='card'><img src='./libs/images/user-icon.png' ><div class='card-body'><p class='fullName'></p><p class='jobTitle'></p><p class='department'></p><p class='location'></p><p class='email'></p></div></div>";
  return card;
}
