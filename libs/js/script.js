  ...
  $.ajax({
    ...
    success: function (result) {
      if (result.status.name == "ok") {
        ...
        for (let i = 0; i < result.data.length; i++) {
          $(".records").append(
            `<div class='card departmentCard'><table><tr><td class='departmentIcon alignCenter'><img src='./img/department-icon.png'></td></tr></table><div class='card-body'><table><tr><td class='departmentName alignCenter'><b>${result.data[i].name}</b></td></tr></table><table class='table table-striped mt-3'><tr><td class='alignLeft'><i class="fas fa-globe-europe"></i><b>Location </b></td><td class='location alignRight'>${result.data[i].location}</td></tr></table><table><tr><td class='alignCenter'><button type='button' id='updateDepartmentBtn' class='btn btn-primary btn-sm' data-bs-toggle='modal'
